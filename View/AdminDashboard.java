...
public class AdminDashboard extends Stage{
    ...
    private Scene CreateCreatAccountsScene;
    ...
    public AdminDashboard() throws IOException {
        ...
        Parent AccountsRoot = CreateAccountsLoader.load();     
        CreateCreatAccountsScene = new Scene(AccountsRoot);
    ...
    public void changeSceneToCreateAccounts(){
        this.setScene(CreateCreatAccountsScene);
    }
